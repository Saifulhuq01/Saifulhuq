  ...
  return (
    <section id="contact" className="relative pt-32 pb-12 mt-20">
      ...
      <div className="mt-24 md:mt-32 pt-12 pb-12 flex flex-col items-center justify-center border-t border-muted/10 font-mono !text-white text-sm md:text-base relative w-full overflow-hidden">
        ...
        <a href="/resume.pdf" target="_blank" rel="noopener noreferrer" className="mt-12 group relative px-10 py-3 overflow-hidden border border-accent flex items-center gap-4 transition-all hover:scale-105 active:scale-95 shadow-lg shadow-accent/5">
