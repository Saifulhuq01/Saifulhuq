...
export default function About() {
  const techStack = [
    'Java', 'Angular', 'PrimeNG', 'RxJS', 'TypeScript', 'JavaScript',
    'Spring Boot', 'Tailwind CSS', 'PostgreSQL', 'MySQL', 'Node.js',
    'Kotlin', 'Firebase', 'C++', 'C', 'Git'
  ];
            ...
            <div>
              <h3 className="text-xl md:text-2xl !text-white mb-4 uppercase flex items-center gap-2">
               ...
               <p className="leading-relaxed !text-white text-sm md:text-base">
                I'm <strong>Mohammed Saifulhuq</strong> — Software Developer at Muthu Soft Labs, Computer Science graduate (B.Sc., 2023), and someone who genuinely believes the best systems are born from curiosity, not convenience.
                <br /><br />
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <p className="leading-relaxed !text-white text-sm md:text-base border-l-2 border-muted/30 pl-4">
                ...
                <br /><br />
                That means compiling custom Android ROMs from raw AOSP sources for OnePlus hardware, navigating device bring-up, and diagnosing bootloops at the <em>logcat</em> and <em>dmesg</em> level. It means patching SQL injection vulnerabilities in a globally deployed fintech engine (Apache Fineract), not because it was assigned — but because the codebase deserved better. It means designing reactive Angular dashboards with <strong>OnPush</strong> change detection and <strong>exhaustMap</strong> pipelines that eliminate race conditions before they ever reach production.
                <br /><br />
